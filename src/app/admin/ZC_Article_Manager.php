...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	?>
		...
		<form action="ZC_Article_Edit.php?action=add" method="post" name="zzcms" id="zzcms" onSubmit="return chk(this)">
			<table align=center border=0 cellspacing=0 cellpadding=0 width="95%"
				class="AdminTable">
				<tr>
					<th colspan="2" align="center">
						<span style="">文章添加</span></th>
				</tr>
				<tr>
...
<td class="td">
						简介：					</td>
					<td height="60">
					  <textarea name="smalltext" id="smalltext" cols="70" rows="15"  maxlength="200" onkeypress="return less_str(this);"></textarea>				    </td>
			  </tr>
				<tr>
		...
		?>
      <form action="ZC_Article_Edit.php?action=modify&tid=<?php echo $row['cid']?>&id=<?php echo $row['id']?>" method="post" name="zzcms" id="zzcms" onSubmit="return chk(this)">
			<table align=center border=0 cellspacing=0 cellpadding=0 width="95%"
				class="AdminTable">
				<tr>
					<th colspan="2" align="center">
						<span style="">文章修改</span></th>
				</tr>
				<tr>
					<td class="td" valign="top" style="padding-top: 7px;">
						所属栏目：					</td>
				...
				<tr>
					<td class="td">
						标题：					</td>
					<td>
						<input name="title" type="text" id="title" style="width: 350px;" value="<?php echo $row['title']?>" maxlength="60" />					</td>
				</tr>
				<tr>
					<td class="td">
						关键字：					</td>
					<td>
						<input name="keywords" type="text" id="keywords"
							style="width: 350px;" value="<?php echo $row['keywords']?>" maxlength="60" />
						(多个用“,”隔开)					</td>
				</tr>
				<tr>
					<td align="left" valign="top" class="td"
				...
				<tr>
					...
					<td>
						<input name="pic" type="text" id="_TopImage"
							style="width: 350px;" value="<?php echo $row['pic']?>" maxlength="60" />
						&nbsp;
                ...
                <tr>
				  <td class="td">
						简介：					</td>
					<td>
                        <textarea name="smalltext" id="smalltext" cols="70" rows="15"  maxlength="200" onkeypress="return less_str(this);"><?php echo $row['smalltext']?></textarea>					</td>
				</tr>
				<tr>
					<td align="left" valign="top" class="td" style="padding-top: 7px;">
						内容：					</td>
