...
<div class="main">
	<div class="main_L">
		<div class="main_new">
		  ...
		  <ul>
		  <?php echo $product->pro_list($cid,10,32,0,0,2,0,0)?>
		  </ul>
	  </div>
		...
		<div class="main_hit">
		  ...
		  <ul>
		  <?php echo $product->pro_list($cid,10,32,0,0,0,0,0)?>
		  </ul>
	  </div>      		
  ...
  <div class="main_R">   
   <div class="path"><?php echo $type->class_path($cid)?></div>     
    <div class="mypiclist">
		<ul>
       <?php echo $product->getpic($cid,0,80,5,0,0,2,120,90,5)?>
	   </ul>
    </div>   
  </div>
</div>
